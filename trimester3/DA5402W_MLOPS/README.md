...
**Course Group Project** (that we had to do instead of an endsem exam): https://github.com/sohang3112/stock-prediction-mlops (done by our group of 4 - me (Sohang Chopra), Ambeth Krishnan, Anish and Gargi)
...
2. https://docs.google.com/document/d/1y5CRfMLdwEoF1nTk9q8qEu1mgMUuUtvhklPKJ2emLU8/edit?tab=t.0#heading=h.ivdr7fm
   rbeab
3. https://colab.research.google.com/drive/1Zh-Uo3TcTH8yYJF-LLo5rjlHVMtqvMdf?usp=sharing#scrollTo=ObOktQOeko5h
4. https://docs.pytorch.org/docs/stable/torch.compiler_dynamo_deepdive.html
...
9. https://www.youtube.com/watch?v=5FNHwPIyHr8
10. https://docs.google.com/document/d/1GgvOe7C8_NVOMLOCwDaYV1mXXyHMXY7ExoewHqooxrs/edit?tab=t.0#heading=h.fh8z
    zonyw8ng
11. https://medium.com/data-science/how-pytorch-2-0-accelerates-deep-learning-with-operator-fusion-and-cpu-gpu-code-
