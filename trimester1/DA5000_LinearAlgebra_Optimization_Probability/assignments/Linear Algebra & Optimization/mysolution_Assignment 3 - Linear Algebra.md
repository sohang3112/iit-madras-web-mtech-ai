...
vector in the column spaces of both matrices such that this will be a vector $A \mathbf{x}$ and also $B \mathbf{x}$.
Think $3 \times 4$ matrix $[A B]$.

---------------- FIX REST -----------------

## Question 2
Suppose there are eight vectors r1, r2, n1, n2, c1, c2, l1, l2 in R4
1. What are the conditions for those pairs to be bases for the four fundamental subspaces
of a 4 X 4 matrix?
2. What is one possible matrix A?
Question 3:
Project the vector b onto the line through a. Check the error vector e is perpendicular to
a.
1. b =


...

Question 4:
Find orthonormal vectors q1, q2, q3 such that q1, q2 span the column space of
A =


1 1
...

1
which of the four fundamental subspaces contains q3?
Question 5:
Find orthonormal vectors A, B, C by Gram-Schmidt method from a, b, c
a =


1
...


prove that A, B, C are bases for the vector perpendicular to d = (1, 1, 1, 1)
Question 6: Let
