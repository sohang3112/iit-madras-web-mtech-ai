...
* Other Items (if any): Optionally support Hindi, Hinglish languages in addition to English. Optionally use synthetic dataset.

## Professor-given Details

Project has 30% overall weightage:
